...
class DeepSeekProvider(BaseProvider):
    ...
    MODELS = {
        "deepseek-chat": ModelInfo(
            ...
            cost_per_1k_prompt_tokens=0.00014,  # Very competitive pricing
            cost_per_1k_completion_tokens=0.00028,
            tags=["chat", "general-purpose", "affordable", "efficient"],
        ),
        "deepseek-reasoner": ModelInfo(
            name="deepseek-reasoner",
            provider="deepseek",
            max_tokens=8192,
            max_context_length=65536,  # 64k context for reasoning tasks
            supports_functions=True,
            supports_vision=False,
            supports_streaming=True,
            cost_per_1k_prompt_tokens=0.00055,  # Higher for reasoning capabilities
            cost_per_1k_completion_tokens=0.0022,
            tags=["reasoning", "analysis", "complex-tasks", "thinking", "advanced"],
        ),
    }
                            ...
                            if choices:
                                ...
                                if content:
                                    ...
                                    yield DeepSeekResponse(
                                        id=chunk_data.get(
                                            "id", f"deepseek-stream-{int(time.time())}"
                                        ),
                                        model=model,
                                        choices=[choice],
