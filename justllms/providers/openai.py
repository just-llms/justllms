...
class OpenAIProvider(BaseOpenAIChatProvider):
    ...
    MODELS = {
        "gpt-5.5": ModelInfo(
            ...
            tags=["flagship", "latest", "reasoning", "multimodal", "long-context", "coding"],
        ),
        "gpt-5.4": ModelInfo(
            name="gpt-5.4",
            provider="openai",
            ...
            tags=["frontier", "reasoning", "multimodal", "long-context", "coding"],
        ),
        "gpt-5.4-pro": ModelInfo(
            ...
            cost_per_1k_completion_tokens=0.18,
            tags=["pro", "reasoning", "multimodal", "long-context", "high-quality"],
        ),
        "gpt-5.4-mini": ModelInfo(
            ...
            supports_functions=True,
            supports_vision=True,
            cost_per_1k_prompt_tokens=0.00075,
            cost_per_1k_completion_tokens=0.0045,
            tags=["mini", "efficient", "multimodal", "agentic", "computer-use"],
        ),
        "gpt-5.4-nano": ModelInfo(
            ...
            tags=["nano", "fastest", "cheapest", "high-throughput"],
        ),
        "gpt-5-nano": ModelInfo(
            ...
            tags=["nano", "fast", "cost-efficient", "multimodal"],
        ),
        "gpt-5": ModelInfo(
            name="gpt-5",
            provider="openai",
