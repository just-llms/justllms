...
class DocumentProcessor:
    ...
    def process_text(self, text: str, metadata: Optional[Dict[str, Any]] = None) -> List[Document]:
        ...
        for i, chunk in enumerate(chunks):
            ...
            documents.append(
                Document(content=chunk, metadata=doc_metadata, embedding=None, score=None)
            )
    ...
    def process_file(
        ...
        text = self._extract_text_from_file(file_path_obj)
        ...
        if self.config.extract_metadata:
            extracted_metadata = self._extract_file_metadata(file_path_obj, text)
    ...
    def _extract_text_from_file(self, file_path: Path) -> str:
        ...
        if suffix == ".txt":
            ...
            try:
                ...
                raise ImportError(
                    "PyPDF2 required for PDF processing. Install with: pip install PyPDF2"
                ) from e
            ...
            try:
                ...
                raise ImportError(
                    "python-docx required for Word processing. Install with: pip install python-docx"
                ) from e
            ...
            try:
                ...
                raise ImportError(
                    "beautifulsoup4 required for HTML processing. Install with: pip install beautifulsoup4"
                ) from e
    ...
    def _extract_text_from_url(self, url: str) -> str:
        ...
        try:
            ...
            raise ImportError("httpx and beautifulsoup4 required for URL processing") from e
...
class RetrievalManager:
    ...
    def __init__(self, config: RetrievalConfig):
        ...
        self.vector_store: VectorStore = create_vector_store(store_type, **store_config)
        ...
        **kwargs: Any,
        ...
        if self.embedding_provider:
            ...
            result = self.vector_store.search_text(
                query=query, collection=collection, k=k, filters=filters, **kwargs
            )
    ...
    async def asearch(
        ...
        **kwargs: Any,
        ...
        documents = await self.vector_store.asearch(
            query_vector=query_vector, collection=collection, k=k, filters=filters, **kwargs
        )
    ...
    def add_texts(
        self, texts: List[Union[str, Dict[str, Any]]], collection: str, **kwargs: Any
    ) -> ProcessingResult:
        ...
        # Add to vector store
        self.vector_store.add_documents(documents, collection)
    ...
    def ingest_documents(
        ...
        **kwargs: Any,
        ...
        if all_documents:
            ...
            # Add to vector store
            self.vector_store.add_documents(all_documents, collection)
    ...
    def create_collection(self, name: str, dimension: Optional[int] = None, **kwargs: Any) -> bool:
    ...
    def delete_documents(self, document_ids: List[str], collection: str, **kwargs: Any) -> bool:
